    ...
    public class ApiClientConfigHelper : ConfigurationHelper, IApiClientConfigHelper
    {
        ...
        private ApiClientConfigHelper()
        {
            try
            {
                ...
                if (!File.Exists(Path.Combine(solutionDir.FullName, @"X:\DataBase\Parser\API_Digi-Key_Parser_new.exe.config")))   //@"X:\DataBase\Parser\API_Digi-Key_Parser_new.exe.config"
                {
                ...
                {
                    ExeConfigFilename = Path.Combine(solutionDir.FullName, @"X:\DataBase\Parser\API_Digi-Key_Parser_new.exe.config"),
                };
